...
import "./page.css"
import image1 from '../component/Images/Rectangle 47.png'
...
const ImageUpload= () => {
  ...
  return (
    ...
    <div className='flex w-[98%] '>
      <div className=' w-full h-full'>
        <div className='flex ' id=''>
          <div className='bg-slate-400 flex flex-col w-full'>
          <div className='flex  w-[70%] gap-6 pt-6 pl-4'>
            <div className=''>
            <div className=''>
    ...
    <div className='flex justify-around gap-3 mt-4 px-2'>
          ...
          <div className='bg-gray-200 flex items-center justify-center rounded-xl w-[30%]'>
