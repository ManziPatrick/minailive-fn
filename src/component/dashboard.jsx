    ...
    return ( 
        ...
        <div className="p-6 h-[100vh] bg-white w-[100%] shadow-2xl border-r-2">
            ...
            <div className="relative width-full dropdown">
                <div>
                    <button className="flex justify-between w-full border-2 border-none shadow-sm p-4 rounded-sm bg-[#F5F8FFB2] text-sm font-medium text-gray-700">
                        <div className="flex gap-5 flex-row align-bottom">
                            <img src={profile} alt="" />
            ...
            <div className="relative width-full mt-2 dropdown">
                <div>
                    <button className="flex justify-between w-full border-2 border-none shadow-sm p-4 rounded-sm bg-white text-sm font-medium text-gray-700">
                        <div className="flex gap-5 flex-row align-bottom">
                            <img src={card} alt="" />
