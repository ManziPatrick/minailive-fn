     ...
     <Router>
      <div className="App">
        <Routes>
          ...
          <Route path="/face-liveness-detection" element={<FaceliveDashbord/>} />
          <Route path="/face-emotions-recognition" element={<EmotionsDashbord/>} />
          <Route path="/credit-card-recognition" element={<CreditCardDashbord/>} />
